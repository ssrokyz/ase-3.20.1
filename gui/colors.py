...
class ColorWindow:
    ...
    def reset(self, gui):
        ...
        values = ['jmol', 'tag', 'force', 'velocity',
                  'initial charge', 'magmom', 'neighbors', 'energies'] # YJ
    ...
    def activate(self):
        ...
        energies = images.get_potential_energies(atoms) ## YJ
        ...
        radio['energies'].active = energies is not None ## YJ
